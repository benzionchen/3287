...
CREATE TABLE Supplier (
    ...
    Category VARCHAR(50), -- e.g., 'Live Stock', 'Topsoil', etc.
    Name VARCHAR(100),
...
CREATE TABLE InventoryItem (
    ...
    Name VARCHAR(100),
    Type ENUM(
        'Tree', 'Shrub', 'Perennial', -- live plants
        'Mulch', 'Gravel', 'Topsoil', 'Stone', 'Paver', 'Timber', 'Sand' -- landscape materials
    ),
...
CREATE TABLE Sale (
    ...
    SaleType ENUM('InStore', 'Delivery', 'Landscaping'), -- In-store pickup, delivery, or part of job
    DeliveryCharge DECIMAL(10,2),
    SalesTax DECIMAL(10,2),
    LandscapingRelated TINYINT(1), -- Flag if part of a landscaping service
...
-- OrderLog Table (ordering inventory items from suppliers)
